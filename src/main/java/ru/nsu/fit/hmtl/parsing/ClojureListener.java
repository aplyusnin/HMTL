...
public interface ClojureListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ClojureParser#boolean_}.
	 * @param ctx the parse tree
	 */
	void enterBoolean_(ClojureParser.Boolean_Context ctx);
	/**
	 * Exit a parse tree produced by {@link ClojureParser#boolean_}.
	 * @param ctx the parse tree
	 */
	void exitBoolean_(ClojureParser.Boolean_Context ctx);
	/**
